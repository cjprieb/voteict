    ...
    <div class="relative">
        <div class="max-w-5xl mx-auto sm:flex justify-between md:items-center pt-8 md:pt-16">
            <div class="px-4 sm:px-8 sm:w-1/2">
                <h1 class="text-2xl font-medium leading-tight font-display mb-56 text-center sm:text-left sm:mb-4 sm:text-4xl">Welcome to VoteICT.org</h1>
                <p class="text-lg leading-normal mb-8">Get text message notifications with relevant information about local&nbsp;elections.</p>
                <div class="sm:pb-24">
                    <a class="btn bg-red-500 hover:bg-red-600 block sm:inline-block mb-4 sm:mr-3" href="{{ 'sms://+1' . env('TWILIO_FROM_NUMBER') . ';?&body=' . __('home.text_subscribe_keyword') }} ">Text START to 864-ICT-VOTE</a>
                    <a class="btn block sm:inline-block" href="#steps">Learn more</a>
                </div>
            </div>
...
<section class="px-8 py-16 sm:py-32 bg-red-200 relative">
    <div class="absolute inset-0 opacity-25" style="background-image: url({{ asset('img/map.png') }})"></div>
    <div class="bg-white max-w-md mx-auto px-10 py-5 text-center rounded-lg shadow-lg relative z-10">
        <h2 class="text-4xl font-medium text-center font-display leading-tight mb-4">
...
<section class="max-w-5xl mx-auto py-10 sm:py-20 px-8">
    <div class="px-4">
        <div class="sm:flex items-center -mx-4">
            <div class="px-4 sm:w-1/2 mb-8 sm:mb-0"></div>
            <div class="px-4 sm:w-1/2">
                <h2 class="text-4xl font-medium font-display leading-tight mb-4">
